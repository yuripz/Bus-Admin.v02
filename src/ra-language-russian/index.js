module.exports = {
    ra: {
        action: {
            ...
            move_down: 'Вниз',
            open: 'Открыть',
            toggle_theme: 'Переключить цвета',
        ...
        message: {
            ...
            bulk_update_content:
                'Вы уверены, что хотите обновить %{name}? |||| Вы уверены, что хотите обновить это %{smart_count}?',
            bulk_update_title:
        ...
        navigation: {
            ...
            partial_page_range_info:
                '%{offsetBegin}-%{offsetEnd} более чем %{offsetEnd}',
        ...
        notification: {
            ...
            http_error: "Ошибка взаимодействия с сервером",
            data_provider_error: "Системная ошибка dataProvider, проверьте консоль браузера",
        ...
        saved_queries: {
            ...
            new_label: 'Сохранение текущего запроса...',
